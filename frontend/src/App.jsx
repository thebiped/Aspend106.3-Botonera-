...
import PerfilOperador from "./components/operador/perfil/PerfilOperador";
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/operador/institucionales" element={<FxInstitucionales />}/>
        <Route path="/operador/perfil" element={<PerfilOperador />} />
